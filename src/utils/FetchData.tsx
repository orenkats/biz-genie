import {parseSubtopics,parseColorPalette,parseTypo,parseCustomerAnalysis} from "@/utils/parseSubtopics";
...
export const generatePrompts = (businessIdea: string) => ({
  ...
  2. "Color Palette": Provide the following details:
     - **[Color Name]**: [Hex Code] - [Description of its emotional/branding impact].
     - **[Color Name]**: [Hex Code] - [Description of its emotional/branding impact].
     - **[Color Name]**: [Hex Code] - [Description of its emotional/branding impact].
     - **[Color Name]**: [Hex Code] - [Description of its emotional/branding impact].
     Ensure each item follows this format:
     - **[Color Name]**: [Hex Code] - [Description of its emotional/branding impact].
  3. "Typography": Provide the following details:
     - **Headings**: Use **[Font Name]** for headings. [Description of style and usage].
     - **Body Text**: Use **[Font Name]** for body text. [Description of style and readability].
...
export const fetchDashboardData = async (businessIdea: string) => {
  ...
  const allData = {
    overview: {
      full: overviewContent,
      colors: parseColorPalette(branding.text),
      typo: parseTypo(branding.text),
      costumerAnalysis: parseCustomerAnalysis(marketingStrategy.text),
    },
